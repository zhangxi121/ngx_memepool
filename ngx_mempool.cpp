...
void ngx_mempool::ngx_pfree(void *p)
{
    ngx_pool_large_s *l;
...
void ngx_mempool::ngx_reset_pool(void)
{
    ngx_pool_s *p;
    ngx_pool_large_s *l;
...
void ngx_mempool::ngx_destroy_pool(void)
{
    ngx_pool_s *p, *n;
    ngx_pool_large_s *l;
...
ngx_pool_cleanup_s *ngx_mempool::ngx_pool_cleanup_add(size_t size)
{
    ngx_pool_cleanup_s *c;
